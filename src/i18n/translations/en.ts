...
const en: TranslationSet = {
  ...
  navbar: {
    ...
    sandboxBanner: 'Pi Sandbox — Testing Mode',
  ...
  checkout: {
    ...
    syncWarning: 'Payment succeeded, but syncing your booking to the server failed — keep your transaction ID as your receipt.',
    ...
    paymentsUnavailable: 'Pi payments are temporarily unavailable while this service is being set up. Please try again later.',
